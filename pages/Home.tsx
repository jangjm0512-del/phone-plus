    ...
    <div className="flex flex-col bg-white">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl relative">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className={`lg:col-span-7 text-center lg:text-left transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <span className="inline-flex items-center gap-2 bg-[#C80000]/10 text-[#C80000] text-[10px] font-black uppercase tracking-[0.3em] px-3 py-1.5 mb-6 rounded-full border border-[#C80000]/20">
                <TrendingUp size={12} /> Best Price Guaranteed
              </span>
              <h1 className="text-3xl lg:text-5xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tighter">
                가장 정직한 곳,<br/>
                <span className="text-[#C80000] relative">
                  폰플러스
                  <span className="absolute -bottom-1.5 left-0 w-full h-1.5 bg-[#C80000]/10 rounded-full"></span>
                </span>에서<br/>
                가치를 증명하세요.
              </h1>
              ...
              <div className="flex flex-col gap-3 max-w-md mx-auto lg:mx-0">
                <Link to="/prices" className="bg-[#C80000] hover:bg-black text-white px-8 py-4 font-black text-lg shadow-2xl transition-all flex items-center justify-center gap-3 group rounded-xl btn-glow">
                  내 폰 시세 확인 <ChevronRight size={20} className="group-hover:translate-x-1.5 transition-transform" />
                </Link>
                <div className="grid grid-cols-3 gap-2.5">
                  <a href="https://open.kakao.com/o/sEKLRvQh" target="_blank" rel="noreferrer" className="bg-[#FEE500] text-black py-3 rounded-xl font-black text-[11px] flex flex-col items-center justify-center gap-1.5 hover:shadow-lg transition-all border border-black/5">
                    <MessageSquare size={18} fill="black" />
                    <span>카톡상담</span>
                  </a>
                  <a href={naverTalkTalkUrl} target="_blank" rel="noreferrer" className="bg-[#03C75A] text-white py-3 rounded-xl font-black text-[11px] flex flex-col items-center justify-center gap-1.5 hover:shadow-lg transition-all">
                    <span className="font-black text-lg leading-none">N</span>
                    <span>톡톡상담</span>
                  </a>
                  <a href={naverPlaceUrl} target="_blank" rel="noreferrer" className="bg-white text-black border border-gray-100 py-3 rounded-xl font-black text-[11px] flex flex-col items-center justify-center gap-1.5 hover:shadow-lg transition-all">
            ...
            <div className={`lg:col-span-5 relative hidden lg:flex flex-col items-center transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
               <div className="w-[280px] h-[280px] bg-gradient-to-br from-gray-50 to-white p-8 rounded-[3rem] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.08)] border border-white flex items-center justify-center relative overflow-hidden group">
                 <div className="bg-[#C80000] p-8 shadow-2xl border-b-[6px] border-black/15 flex items-center justify-center gap-2 font-black tracking-tighter w-full floating rounded-2xl relative z-10">
      ...
      <section className="py-16 bg-gray-50/50 relative">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-lg border border-gray-100 flex flex-col lg:flex-row items-center justify-between gap-10 relative overflow-hidden">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 text-[#C80000] font-black mb-5 uppercase tracking-widest text-[11px] bg-red-50 px-3 py-1 rounded-full border border-red-100">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                 {[ "신용불량·연체 OK", "본인명의 100%", "위약금 제로" ].map((text, i) => (
                   <span key={i} className="flex items-center gap-2 text-gray-500 font-bold text-[13px] bg-gray-100 px-3 py-1.5 rounded-lg">
            ...
            <div className="w-full lg:w-[320px]">
               <div className="bg-gray-900 p-8 text-center flex flex-col items-center rounded-3xl shadow-2xl">
                  <p className="text-gray-400 font-black text-[10px] mb-2 uppercase tracking-widest">개통비 포함 파격가</p>
                  <p className="text-5xl font-black text-white mb-8 tracking-tighter italic">
                    10,000<span className="text-lg not-italic text-gray-500 ml-1 uppercase">won</span>
                  </p>
                  <a href={naverTalkTalkUrl} target="_blank" rel="noreferrer" className="w-full bg-[#03C75A] text-white px-6 py-4 rounded-xl font-black text-base hover:bg-[#02b351] transition-all flex items-center justify-center gap-2">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {reviews.map((rev, i) => (
              <div key={i} className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="bg-[#03C75A]/10 text-[#03C75A] text-[9px] px-2 py-0.5 rounded-full font-bold uppercase">Verified</span>
                    </div>
                  </div>
                  <span className="text-[10px] text-gray-300 font-bold">{rev.date}</span>
                </div>
                <p className="text-gray-500 font-medium leading-relaxed text-[14px] mb-6 flex-grow">"{rev.content}"</p>
          ...
          <div className="flex justify-center">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="inline-flex items-center gap-3 bg-white border-2 border-gray-900 text-gray-900 px-8 py-4 rounded-xl font-black text-base hover:bg-gray-900 hover:text-white transition-all shadow-xl"
            >
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-6">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl md:text-5xl font-black mb-4 tracking-tighter">실시간 매입 시세</h2>
              <p className="text-gray-400 font-bold text-lg">데이터 추가 시 자동으로 실시간 업데이트됩니다.</p>
            </div>
            <div className="flex justify-center lg:justify-end gap-2">
               <span className="flex items-center gap-2 bg-red-500/10 text-red-500 px-3 py-1.5 rounded-full text-[12px] font-black animate-pulse">
                 <Clock size={14} /> LIVE TICKER
               </span>
            </div>
          </div>
              ...
              <div className="flex-grow overflow-hidden relative">
                <div className="absolute inset-0 flex flex-col transition-transform duration-1000 ease-in-out" style={{ transform: `translateY(-${(activePriceIdx % Math.max(1, applePrices.length)) * 80}px)` }}>
                  {[...applePrices, ...applePrices].map((item, i) => (
                    <div key={`${item.id}-${i}`} className="h-[80px] p-6 flex justify-between items-center border-b border-white/5 shrink-0">
                      <div>
                      ...
                      <div className="text-right">
                        <p className="text-[10px] text-red-500 font-black mb-1 uppercase">Max</p>
                ...
                <div className="absolute inset-0 flex flex-col transition-transform duration-1000 ease-in-out" style={{ transform: `translateY(-${((activePriceIdx + 1) % Math.max(1, samsungPrices.length)) * 80}px)` }}>
                  {[...samsungPrices, ...samsungPrices].map((item, i) => (
                    <div key={`${item.id}-${i}`} className="h-[80px] p-6 flex justify-between items-center border-b border-white/5 shrink-0">
                      ...
                      <div className="text-right">
                        <p className="text-[10px] text-blue-400 font-black mb-1 uppercase tracking-widest">Max</p>
                        <p className="text-2xl font-black text-white tracking-tighter">{item.maxPrice.toLocaleString()}원</p>
                      </div>
                    </div>
                  ))}
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 pt-10 border-t border-white/10">
            <Link to="/prices" className="group flex items-center gap-3 text-white font-black hover:text-red-500 transition-all text-[13px] uppercase tracking-widest">
              전체 시세표 상세 보기 <ChevronRight size={18} />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="bg-gray-900 p-10 md:p-16 rounded-[3.5rem] flex flex-col lg:flex-row items-center justify-between gap-12 shadow-2xl relative overflow-hidden">
            <div className="text-center lg:text-left relative z-10 flex-1">
              ...
              <h4 className="text-2xl md:text-3xl font-black text-white leading-tight tracking-tighter mb-6">
                부산광역시 동래구 온천천로 165<br/>
                롯데캐슬 퀸 상가 102동 2층 207호
              </h4>
              <div className="space-y-3 text-gray-400 font-medium text-base">
                <p className="flex items-center gap-2.5 justify-center lg:justify-start"><Clock size={18} className="text-red-500" /> 평일 10:00 - 20:00 / 토요일 11:00 - 20:00</p>
                <p className="flex items-center gap-2.5 justify-center lg:justify-start"><Navigation size={18} className="text-red-500" /> 동래역 2번 출구 앞 헌혈의 집 옆 매장</p>
              </div>
            </div>
            
            <div className="flex flex-col gap-3 w-full lg:w-[280px] relative z-10">
              <a href={naverPlaceUrl} target="_blank" rel="noreferrer" className="bg-[#03C75A] text-white p-5 rounded-2xl font-black text-lg flex items-center justify-center gap-2.5 hover:scale-105 transition-all shadow-xl">
                <Navigation size={20} fill="white" /> 네이버 지도
              </a>
              <a href={`tel:${config.contactNumber}`} className="bg-white text-gray-900 p-5 rounded-2xl font-black text-lg flex items-center justify-center gap-2.5 hover:scale-105 transition-all shadow-xl">
                <PhoneCall size={20} /> 전화 상담
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-3">
         ...
         <a href="https://open.kakao.com/o/sEKLRvQh" target="_blank" rel="noreferrer" className="w-14 h-14 bg-[#FEE500] text-black rounded-2xl flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all">
